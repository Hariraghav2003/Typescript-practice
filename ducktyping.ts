...
let aobj: Record<string, any> = { id: 1, name: "Hari" };// Using the record keyword we declare that the key can be any string & values can be any datatype 
